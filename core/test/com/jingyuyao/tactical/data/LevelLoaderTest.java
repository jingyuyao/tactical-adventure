...
public class LevelLoaderTest {
  ...
  @Before
  public void setUp() {
    levelLoader = new LevelLoader(dataConfig, jsonSerializer, files, terrainsLoader, scriptLoader);
  }
  ...
  public void create_new_save() {
    ...
    when(jsonSerializer.deserialize(reader1, LevelWorld.class)).thenReturn(levelWorld);
