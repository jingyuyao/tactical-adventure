...
class UIBundle {
  ...
  static final StringKey MENU_BTN = BUNDLE.get("menuBtn");
  ...
  static final StringKey PERSON_ROLE_HEADER = BUNDLE.get("personRoleHeader");
  static final StringKey ITEM_NAME_HEADER = BUNDLE.get("itemNameHeader");
  static final StringKey ITEM_DURABILITY_HEADER = BUNDLE.get("itemDurabilityHeader");
  static final StringKey ITEM_DESCRIPTION_HEADER = BUNDLE.get("itemDescriptionHeader");
