...
public class EventBusObject {
  ...
  /**
   * Register this object to {@link #eventBus} if it has not been registered. Safe to be called
   * multiple times without any performance hit. Each class with {@link
   * com.google.common.eventbus.Subscribe} annotation should call this just in case the parent class
   * doesn't call it.
   */
